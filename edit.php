			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="fakultas" class="form-control" required>
						...
						<option value="SOSIAL" <?php if($data['fakultas'] == 'SOSIAL'){ echo 'selected'; } ?>>SOSIAL</option>
						<option value="DOKTER" <?php if($data['fakultas'] == 'DOKTER'){ echo 'selected'; } ?>>DOKTER</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
